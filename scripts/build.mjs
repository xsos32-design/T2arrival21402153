國,PHX:美國,PKX:中國,PNH:柬埔寨,PPS:菲律賓,PQC:越南,PRG:捷克,PUS:韓國,PVG:中國,REP:柬埔寨,RGN:緬甸,RMQ:台灣,ROR:帛琉,RSU:韓國,RUH:沙烏地,SAN:美國,SAW:土耳其,SCL:智利,SDJ:日本,SEA:美國,SFO:美國,SGN:越南,SHA:中國,SHE:中國,SHI:日本,SHM:日本,SIN:新加坡,SJC:美國,SJW:中國,SLC:美國,SMF:美國,SPK:日本,SPN:塞班,STR:德國,SUB:印尼,SVO:俄羅斯,SWA:中國,SYD:澳洲,SYO:日本,SYX:中國,SZX:中國,TAE:韓國,TAG:菲律賓,TAK:日本,TAO:中國,TFU:中國,THD:越南,TKS:日本,TLV:以色列,TNA:中國,TNN:台灣,TOY:日本,TSA:台灣,TSN:中國,TTJ:日本,TTT:台灣,TYN:中國,UBJ:日本,UKB:日本,ULN:蒙古,URC:中國,USM:泰國,USN:韓國,UTP:泰國,VCA:越南,VCE:義大利,VDH:越南,VIE:奧地利,VII:越南,VTE:寮國,VVO:俄羅斯,WAW:波蘭,WEH:中國,WKJ:日本,WLG:紐西蘭,WNZ:中國,WUH:中國,WUX:中國,XIY:中國,XMN:中國,XUZ:中國,YEG:加拿大,YGJ:日本,YHZ:加拿大,YIW:中國,YNT:中國,YNY:韓國,YNZ:中國,YOW:加拿大,YUL:加拿大,YVR:加拿大,YXU:加拿大,YYC:加拿大,YYZ:加拿大,ZHA:中國,ZQN:紐西蘭,ZRH:瑞士,ZUH:中國'.split(',')) { const p = kv.split(':'); o[p[0]] = p[1]; }
  return o; })();
const ctryOf = f => CTRY[String(f.CityCode || f.Dep || '').trim().toUpperCase()] || '';
/* 出發地一律帶國旗；查不到就給地球，格式才會統一 */
const flagCell = f => {
  const ct = ctryOf(f), fg = flagOf(ct);
  if (fg) return `<i class="cty" title="${esc(ct)}">${fg}</i>`;
  const code = String(f.CityCode || f.Dep || '').trim().toUpperCase();
  return `<i class="cty" title="${esc(code || '出發地不明')} 還沒對照到國家">\u{1F310}</i>`;
};
/* 國旗：國名 → ISO 兩碼，再用 regional indicator 組出旗子（比直接存 53 面旗省字） */
const FLAG = (() => { const o = {};
  for (const kv of '中國:CN,丹麥:DK,以色列:IL,俄羅斯:RU,加拿大:CA,匈牙利:HU,南非:ZA,卡達:QA,印尼:ID,印度:IN,土耳其:TR,塞班:MP,奧地利:AT,孟加拉:BD,寮國:LA,尼泊爾:NP,希臘:GR,帛琉:PW,德國:DE,挪威:NO,捷克:CZ,斯里蘭卡:LK,新加坡:SG,日本:JP,柬埔寨:KH,比利時:BE,汶萊:BN,沙烏地:SA,法國:FR,波蘭:PL,泰國:TH,澳洲:AU,澳門:MO,瑞典:SE,瑞士:CH,紐西蘭:NZ,緬甸:MM,美國:US,義大利:IT,芬蘭:FI,英國:GB,荷蘭:NL,菲律賓:PH,葡萄牙:PT,蒙古:MN,西班牙:ES,越南:VN,關島:GU,阿聯:AE,韓國:KR,香港:HK,馬來西亞:MY,馬爾地夫:MV,台灣:TW,斐濟:FJ,墨西哥:MX,巴西:BR,智利:CL,秘魯:PE,阿根廷:AR,愛爾蘭:IE,巴林:BH,科威特:KW,阿曼:OM,約旦:JO,埃及:EG,肯亞:KE,奈及利亞:NG,巴基斯坦:PK,不丹:BT'.split(',')) { const p = kv.split(':'); o[p[0]] = p[1]; }
  return o; })();
...
.r.r40 .g .gn{background:#14b8a6;color:#04221e}
.r.r53 .g .gn{background:#f97316;color:#2c1204}
...
(function(){
  try{
    ...
    /* 這頁不連網，資料可能是好幾小時前的。超過 30 分鐘就用一整條紅帶講清楚，
       不要只靠角落那個小字。 */
