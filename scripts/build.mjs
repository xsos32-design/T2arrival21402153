...
/* 浮動快捷鍵：置頂／現在時段／更新 */
/* 手錶版：按鈕就排在最上面跟著內容捲。手錶的瀏覽器擋不住固定定位造成的滑動問題，
   固定只在 420px 以上（手機／電腦）才開。 */
...
@media(min-width:300px){
 ...
 #fab{position:fixed;top:5px;left:5px;right:5px;z-index:70;margin:0;pointer-events:none}
 .fabb{pointer-events:auto}
}
@media(min-width:420px){
 body{max-width:680px;margin:0 auto;padding:14px;padding-top:70px}
 #fab{position:fixed;z-index:70;top:12px;right:16px;left:auto;margin:0;padding:0;gap:8px;
